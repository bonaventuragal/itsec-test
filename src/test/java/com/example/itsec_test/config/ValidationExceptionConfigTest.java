...
class ValidationExceptionConfigTest {
	...
	void testHandleResponseStatusException() {
		ResponseStatusException ex = new ResponseStatusException(org.springframework.http.HttpStatus.BAD_REQUEST, "Error message");

		ResponseEntity<Map<String, Object>> response = config.handleResponseStatusException(ex);
